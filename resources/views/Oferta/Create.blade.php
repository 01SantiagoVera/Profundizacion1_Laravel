...
@section('title', 'Nueva Oferta de Práctica')

@section('content')
    <div class="card p-4 shadow-sm mb-4 bg-dark">
        <h3 class="fw-bold text-center text-uppercase text-white p-2 mb-3">Registrar Nueva Oferta</h3>
        <form action="{{ route('Oferta.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control bg-dark text-white border-light rounded @error('descripcion') is-invalid @enderror"
                          ...
                          placeholder="Describe la oferta de práctica" rows="3" required>{{ old('descripcion') }}</textarea>
                @error('descripcion')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control bg-dark text-white border-light rounded @error('requisitos') is-invalid @enderror"
                          ...
                          placeholder="Especifica los requisitos de la oferta" rows="3">{{ old('requisitos') }}</textarea>
                @error('requisitos')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control bg-dark text-white border-light rounded @error('habilidades') is-invalid @enderror"
                          ...
                          placeholder="Especifica las habilidades requeridas" rows="2">{{ old('habilidades') }}</textarea>
                @error('habilidades')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
